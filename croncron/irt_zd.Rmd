...
a<-dichoDif(data, group="gender", focal.name=1, method=c("Lord"), model="2PL")
a
```
...
```{r}
plot(model, type="ICC", items=c(1,2,3,4,5, 6))
abline(.5,0)
...
mod3pl<-tpm(dat_base, type="latent.trait", IRT.param=TRUE)
anova(mod1pl, mod2pl)
# anova(mod2pl, mod3pl)
# anova(mod2pl, mod1pl)
