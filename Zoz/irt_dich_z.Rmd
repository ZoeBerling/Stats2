...
data$Q1A[data$Q1A==1]<- 0
data$Q1A[data$Q1A==2]<- 0
data$Q1A[data$Q1A==3]<- 1
data$Q1A[data$Q1A==4]<- 1
data$Q2A[data$Q2A==1]<- 0
data$Q2A[data$Q2A==2]<- 0
data$Q2A[data$Q2A==3]<- 1
data$Q2A[data$Q2A==4]<- 1
data$Q3A[data$Q3A==1]<- 0
data$Q3A[data$Q3A==2]<- 0
data$Q3A[data$Q3A==3]<- 1
data$Q3A[data$Q3A==4]<- 1
data$Q4A[data$Q4A==1]<- 0
data$Q4A[data$Q4A==2]<- 0
data$Q4A[data$Q4A==3]<- 1
data$Q4A[data$Q4A==4]<- 1
data$Q5A[data$Q5A==1]<- 0
data$Q5A[data$Q5A==2]<- 0
data$Q5A[data$Q5A==3]<- 1
data$Q5A[data$Q5A==4]<- 1
data$Q6A[data$Q6A==1]<- 0
data$Q6A[data$Q6A==2]<- 0
data$Q6A[data$Q6A==3]<- 1
data$Q6A[data$Q6A==4]<- 1
...
str(IRTmodelM)
# print(IRTmodelM['z'])
# p1 = plot(IRTmodelM, type ="ICC", item = 1)
# p2 = plot(IRTmodelF, type = "ICC", item=1)
# p1+p2
